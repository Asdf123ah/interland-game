...
import questions from './CommunicationSkillQuestion';

const CommunicationSkill = () => {
  const { userId } = useParams();
  const navigate = useNavigate(); 
  const category = 'Communication Skill';
    ...
    <div className="containerGame">
      ...
      {showPopup && (
        <div className="popup" onClick={handlePopupClick}>
          ...
          <p>Digital communication skills are essential for navigating today's digital landscape, enabling individuals to securely and efficiently communicate using technology. These skills involve utilizing appropriate digital tools to achieve personal and professional objectives and remaining adaptable to emerging technological advancements.</p>
