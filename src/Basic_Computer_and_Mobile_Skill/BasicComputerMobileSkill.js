...
import questions from './BasicComputerMobileSkillQuestion';

const BasicComputerMobileSkill = () => {
    ...
    <div className="containerGame">
      ...
      {showPopup && (
        <div className="popup" onClick={handlePopupClick}>
          <h1>Basic Computer and Mobile Skill</h1>
          <p>Basic computer and mobile skills are crucial for adapting to new technologies and transferring expertise across different devices and programs. In today's society, computer literacy is essential for success in work, education, and communication, as highlighted by experts. Mobile devices are increasingly relied upon for information, offering accessibility and flexibility in learning.</p>
...
export default BasicComputerMobileSkill;