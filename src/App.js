  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/category-selection/:userId" element={<CategorySelection />} />
        <Route path="/information-literacy-skill/:userId/" element={<InformationLiteracySkill />} />
        <Route path="/basic-computer-and-mobile-skill/:userId" element={<BasicComputerMobileSkill />} />
        <Route path="/communication-skill/:userId" element={<CommunicationSkill />} />
