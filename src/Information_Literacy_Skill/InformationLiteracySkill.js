...
import questions from './InformationLiteracySkillQuestion';

const InformationLiteracySkill = () => {
  const { userId } = useParams();
  const navigate = useNavigate(); 
  const category = 'Information Literacy Skill';
    ...
    <div className="containerGame">
      ...
      {showPopup && (
        <div className="popup" onClick={handlePopupClick}>
          <h1>Information Literacy Skill</h1>
          <p>Information Literacy Skills enables individuals to effectively find, evaluate, and ethically use information for both personal and professional purposes. These skills involve navigating online resources with competence and critically analyzing the credibility of information, especially in an era of misinformation and fake news.</p>
...
export default InformationLiteracySkill;