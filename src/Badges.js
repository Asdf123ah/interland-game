      ...
      <div className='abc'>
        {showBasicBadgePopup && (
          <div className="popup-statistic">
            ...
            <div className='box-statistic2'>
              ...
              <p>You earned a badge by mastering the foundation of BASIC COMPUTER AND MOBILE SKILLS! You may now proceed to user statistics to view your progress and badges. Collect all badges to improve your digital literacy proficiency and enjoy the process.</p>
            </div>
        ...
        {!showBasicBadgePopup && showInternetBadgePopup && (
          <div className="popup-statistic">
            ...
            <div className='box-statistic2'>
              <div>Congratulations!</div>
              <p>You earned a badge by mastering the foundation of INTERNET SKILLS! You may now proceed to user statistics to view your progress and badges. Collect all badges to improve your digital literacy proficiency and enjoy the process.</p>
            </div>
        ...
        {!showBasicBadgePopup && !showInternetBadgePopup && showCommunicationBadgePopup && (
          <div className="popup-statistic">
            ...
            <div className='box-statistic2'>
              <div>Congratulations!</div>
              <p>You earned a badge by mastering the foundation of COMMUNICATION SKILLS! You may now proceed to user statistics to view your progress and badges. Collect all badges to improve your digital literacy proficiency and enjoy the process.</p>
            </div>
        ...
        {!showBasicBadgePopup && !showInternetBadgePopup && !showCommunicationBadgePopup && showInformationBadgePopup && (
          <div className="popup-statistic">
            ...
            <div className='box-statistic2'>
              <div>Congratulations!</div>
              <p>You earned a badge by mastering the foundation of INFORMATION LITERACY SKILLS! You may now proceed to user statistics to view your progress and badges. Collect all badges to improve your digital literacy proficiency and enjoy the process.</p>
            </div>
